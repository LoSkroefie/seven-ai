...
| `core/conversation_memory.py` + `extensions/action_item_digest.py` | Conversation summaries and extracted actions | Messages, facts, tasks and digests exist separately | Port extraction/dedup/migration with explicit privacy controls |
