...
- **106 built-in registered tools**: shell, strict OpenSSH, read-only GitHub, grounded project catalog, files, structured documents, owned local music, versioned skills, screen/mouse/keyboard, web, vision, Python, clipboard, notifications, evidence-gated goals/tasks/action review, extensions, benchmarked Ollama model lifecycle with rollback, coding CLIs and acknowledged robot bus operations
